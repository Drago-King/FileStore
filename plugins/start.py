...
def clean_caption(caption):
    """
    Remove all embedded links, any line with 'Powered By' and '@BoB_Files1', all @usernames, and the golden emoji from the caption.
    """
    if not caption:
        return caption
    ...
    # Remove all @usernames (words starting with @)
